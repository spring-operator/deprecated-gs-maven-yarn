...
include::https://raw.github.com/spring-guides/getting-started-macros/master/describe_shdp_yarn_deps_maven.adoc[]
...
[source,text]
----
gs-gradle-maven-dist/target/dist/gs-gradle-maven-client-0.1.0.jar
gs-gradle-maven-dist/target/dist/gs-gradle-maven-container-0.1.0.jar
gs-gradle-maven-dist/target/dist/gs-gradle-maven-appmaster-0.1.0.jar
----

You can run the project with `cd gs-gradle-maven-dist && java -jar
target/dist/gs-gradle-maven-client-0.1.0.jar` but we haven't added the
